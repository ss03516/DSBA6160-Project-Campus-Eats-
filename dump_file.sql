...
INSERT INTO `driver` VALUES (1,110,'fi3980','1989-01-18',2.77778),(2,98,'js4003','2017-03-15',2.77778),(3,104,'xt8429','2002-10-11',2.77778),(4,43,'yv6392','2010-02-23',2.77778),(5,75,'cf3679','1997-04-06',2.77778),(6,68,'rx3942','1970-03-24',2.77778),(7,143,'mf2647','2014-05-06',2.77778),(8,96,'ia9372','2011-06-25',2.77778);
/*!40000 ALTER TABLE `driver` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `driver_rating_view`
--

DROP TABLE IF EXISTS `driver_rating_view`;
/*!50001 DROP VIEW IF EXISTS `driver_rating_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driver_rating_view` AS SELECT 
 1 AS `driver_id`,
 1 AS `person_name`,
 1 AS `Order Count`,
 1 AS `Rating`*/;
...
--
-- Temporary view structure for view `order_rating_comparison`
--

DROP TABLE IF EXISTS `order_rating_comparison`;
/*!50001 DROP VIEW IF EXISTS `order_rating_comparison`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `order_rating_comparison` AS SELECT 
 1 AS `order_id`,
 1 AS `driver_id`,
 1 AS `person_name`,
 1 AS `Driver Rating`,
 ...
 1 AS `Average_Order_Rating`,
 1 AS `Average Driver's Order's Rating`,
 1 AS `Average Restaurant's Order's Rating`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `rating` (
  ...
  CONSTRAINT `fk_r_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
...
INSERT INTO `rating` VALUES (1,39,3,111,3,4),(2,22,5,82,4,1),(3,25,3,9,1,3),(4,74,2,55,1,3),(5,53,5,179,3,2),(6,72,2,157,5,4),(7,95,7,88,5,3),(8,69,6,56,1,3),(9,42,3,159,5,4),(10,28,1,63,3,3),(11,37,7,71,1,2),(12,70,3,56,5,4),(13,76,7,3,1,5),(14,79,4,199,3,4),(15,72,3,144,2,3),(16,8,2,23,2,4),(17,91,7,165,1,5),(18,61,7,201,5,4),(19,36,6,50,1,3),(20,47,3,89,4,2),(21,72,5,128,4,5),(22,44,4,53,4,1),(23,62,4,60,2,4),(24,57,6,178,2,3),(25,61,5,17,3,4),(26,75,7,74,4,4),(27,50,8,196,2,2),(28,27,6,160,3,2),(29,79,6,90,4,2),(30,36,4,33,5,3),(31,25,2,36,4,2),(32,3,4,140,3,4),(33,60,5,66,4,1),(34,83,6,51,3,5),(35,34,6,73,3,2),(36,50,6,4,2,4),(37,77,3,17,3,4),(38,62,1,27,5,1),(39,44,4,69,5,4),(40,30,2,84,1,2),(41,57,6,68,3,4),(42,86,2,10,3,5),(43,16,1,187,1,2),(44,86,3,25,2,1),(45,5,7,33,4,4),(46,35,3,75,2,4),(47,24,3,101,2,4),(48,43,5,123,4,2),(49,65,8,81,5,4),(50,44,8,14,2,2),(51,23,5,134,3,2),(52,91,8,89,4,4),(53,68,2,195,3,2),(54,90,8,84,4,1),(55,43,5,205,4,4),(56,17,5,194,5,4),(57,5,5,20,5,4),(58,18,4,110,4,3),(59,15,2,75,2,3),(60,51,5,202,4,1),(61,39,8,171,3,3),(62,29,4,11,2,4),(63,13,5,105,3,5),(64,85,2,86,3,2),(65,25,6,144,2,3),(66,18,1,193,4,4),(67,79,2,128,4,2),(68,91,7,175,4,2),(69,68,3,76,2,4),(70,21,8,48,4,3),(71,43,1,169,1,2),(72,98,6,135,5,1),(73,48,4,39,2,3),(74,15,7,3,1,1),(75,28,8,30,4,4),(76,35,3,90,1,5),(77,53,4,175,2,3),(78,17,1,189,2,3),(79,44,4,135,3,4),(80,43,4,11,2,5),(81,76,4,113,1,1),(82,31,5,133,3,1),(83,53,2,188,3,1),(84,45,8,172,5,4),(85,17,4,162,4,5),(86,49,5,41,4,3),(87,42,4,166,1,3),(88,66,5,11,1,2),(89,94,6,132,1,1),(90,28,1,20,4,3),(91,27,8,126,5,3),(92,94,2,163,2,4),(93,26,6,68,3,5),(94,48,5,74,1,4),(95,49,1,40,3,1),(96,39,1,70,2,1),(97,79,5,131,4,3),(98,62,7,90,3,2),(99,76,3,91,2,4),(100,71,3,173,1,2),(101,48,5,46,2,2);
...
INSERT INTO `restaurant` VALUES (1,'5357 Adrianna Shoal Suite 418\nEnochside, OH 46739-1915','Rath Ltd','9am -10pm','http://hahn.com/',3.25),(2,'6977 Adams Locks Suite 001\nErikastad, LA 55321-5793','Kerluke-Herman','11am - 11pm','http://wilderman.com/',3.25),(3,'559 Robin Cape\nWest Merl, OH 31271-9957','Berge Inc','11am - 11pm','http://okunevarohan.com/',3.25),(4,'4501 Labadie Via\nLake America, NJ 33290','Hamill, Prohaska and Lehner','10am - 9pm','http://jacobswilderman.info/',3.25),(5,'5587 Fanny Port\nNorth Nigel, NC 05813','Ratke LLC','10am - 9pm','http://www.williamson.org/',3.25),(6,'3906 Wilkinson Street Suite 611\nLake Moisesburgh, DE 83148','Fisher-Rempel','9am -10pm','http://www.lehner.net/',3.25),(7,'459 Labadie Course Suite 026\nNorth Ola, ND 60631','Ryan, Jaskolski and Schinner','10am - 9pm','http://www.schuster.org/',3.25),(8,'630 Block Harbors\nEast Rudolphhaven, LA 44638','Kub, Borer and Ward','11am - 11pm','http://klingprohaska.com/',3.25),(9,'40616 Mante Islands\nSouth Gileschester, MI 75466','O\'Conner-Mraz','9am -10pm','http://www.rosenbaum.com/',3.25),(10,'9015 Velma Junction\nSpencerland, KY 15821-5602','Mayert LLC','9am -10pm','http://www.raynorgoldner.com/',3.25),(11,'48482 Bode Harbors\nPort Modesta, AZ 10082-7993','Grady, Kreiger and Frami','10am - 9pm','http://skiles.com/',3.25),(12,'597 Leora Summit Apt. 714\nEbertbury, WI 48130-6262','Abbott-Schmitt','9am -10pm','http://feil.com/',3.25),(13,'387 Tromp Estates Suite 445\nWest Leopoldshire, NC 80009','Ankunding Group','9am -10pm','http://www.balistreri.info/',3.25),(14,'679 Russel Villages\nConnellyfort, MD 72266','Weber, Lehner and Mueller','9am -10pm','http://mccullough.com/',3.25),(15,'177 Katrina Gateway Apt. 797\nJastport, MN 44988-2805','Connelly, Wolf and Murazik','10am - 9pm','http://mraz.com/',3.25),(16,'3136 Kunde Ports Apt. 399\nLake Trevor, CO 19002','Abernathy, Lehner and Zulauf','10am - 9pm','http://kirlinkulas.com/',3.25),(17,'03334 Blanda Trafficway Suite 568\nFloyfort, OK 34900-7724','Heathcote, Kovacek and Cummerata','9am -10pm','http://glover.biz/',3.25),(18,'031 Milton Bypass Suite 952\nStephonburgh, WY 82916-7389','Hauck, Rodriguez and Cremin','11am - 11pm','http://reynolds.com/',3.25),(19,'375 Alanna Crossroad Suite 259\nNorth Shanna, MN 54873','Hermiston-Purdy','11am - 11pm','http://herzog.com/',3.25),(20,'9359 Marcos Park Apt. 091\nSchmitttown, IL 68853','Smitham-Haley','11am - 11pm','http://quitzonmckenzie.com/',3.25),(21,'215 Shanon Creek\nEast Antonettaview, MN 74167-8029','Cruickshank-Reilly','10am - 9pm','http://rodriguezkshlerin.com/',3.25),(22,'0562 Cassin Divide\nElenorafurt, AR 37048','Eichmann-Casper','10am - 9pm','http://www.farrell.biz/',3.25),(23,'41925 Bosco Station Apt. 238\nSouth Clara, MA 87547-3817','Gorczany, Kuphal and Pouros','9am -10pm','http://www.dare.com/',3.25),(24,'9119 Cummerata Avenue Suite 529\nAbshiremouth, ND 00145-7770','Moen Ltd','9am -10pm','http://www.eichmannhomenick.org/',3.25),(25,'422 Lesch Common Apt. 940\nNew Felicitaborough, IL 21308-3053','Keeling, Maggio and Hirthe','10am - 9pm','http://hermannwalter.info/',3.25),(26,'52787 Ullrich Locks\nReynoldsside, IA 48689-5885','Mraz, Reichel and Hermiston','11am - 11pm','http://www.runolfsdottir.com/',3.25),(27,'1135 Bartell Islands\nLake Philipton, HI 43588-0971','Oberbrunner-Herman','10am - 9pm','http://www.rice.com/',3.25),(28,'8279 Concepcion Center\nHauckshire, AL 83821','Stanton-D\'Amore','9am -10pm','http://nienow.com/',3.25),(29,'283 Nadia Islands\nAudreanneburgh, GA 64125-4442','Waelchi LLC','11am - 11pm','http://www.littel.net/',3.25),(30,'093 Fredrick Spurs\nSouth Shannamouth, RI 24292','Ziemann, Denesik and Kunze','10am - 9pm','http://www.klinghilll.info/',3.25),(31,'3948 Kiehn Forest Apt. 782\nHageneschester, VT 94419','Tromp Ltd','9am -10pm','http://white.com/',3.25),(32,'4652 Maeve Brook\nSouth Corine, WA 21701-5426','Beatty Ltd','11am - 11pm','http://parisian.biz/',3.25),(33,'4863 Becker Spring\nNorth Candelarioburgh, UT 16649-1046','Gutmann LLC','10am - 9pm','http://beahan.net/',3.25),(34,'46083 Mekhi Ridge\nLake Jerrodhaven, VT 38507-5949','Macejkovic Ltd','9am -10pm','http://www.beahan.com/',3.25),(35,'214 Lyric Mission\nPort Meaganview, AR 17033','Rolfson LLC','9am -10pm','http://skiles.com/',3.25),(36,'96083 Konopelski Isle Suite 006\nBruenfort, KY 49444-9497','Marquardt, Reinger and Gusikowski','11am - 11pm','http://www.daniel.com/',3.25),(37,'213 Larkin Coves\nQuintonside, TX 07955','Harber Group','10am - 9pm','http://www.goodwin.biz/',3.25),(38,'0859 Hills Pine Apt. 888\nMyriammouth, NM 69940-8316','Wuckert, Reilly and Wuckert','9am -10pm','http://www.boscokilback.com/',3.25),(39,'67511 Graham Shore\nLaceyland, WI 78493','Kirlin, Gibson and Kovacek','9am -10pm','http://schinner.com/',3.25),(40,'0416 Nyasia Hills\nWest Penelope, MA 56613','Morissette, Kutch and Spinka','11am - 11pm','http://www.smitham.biz/',3.25),(41,'6044 Prohaska Oval\nWillton, MI 09742','Corkery, Kilback and Skiles','10am - 9pm','http://www.schumm.com/',3.25),(42,'0561 Dora Manors Suite 455\nNew Aliamouth, CO 28487-7002','Huels-Considine','11am - 11pm','http://dareboehm.biz/',3.25),(43,'719 Virgil Orchard Apt. 083\nSouth Amalia, KY 78515-9294','Gusikowski, Funk and Rau','10am - 9pm','http://www.johnston.org/',3.25),(44,'8474 Joana Rest\nNorth Kariane, MI 13273-8980','Friesen, Zemlak and Runolfsson','9am -10pm','http://www.schillerstreich.org/',3.25),(45,'85504 Jacky Radial Suite 460\nBeauberg, ND 20689','Hayes-O\'Hara','9am -10pm','http://www.feest.net/',3.25),(46,'791 Lennie Tunnel Apt. 153\nTyreekshire, DC 94328','Sporer, Reinger and Runte','10am - 9pm','http://www.gerhold.com/',3.25),(47,'269 Keeling Forks\nBauchfort, TN 32390-9816','Rutherford, Cummerata and Langosh','10am - 9pm','http://pacocha.net/',3.25),(48,'976 Gislason Heights Suite 926\nChristiansenshire, FL 00995','McGlynn PLC','10am - 9pm','http://langoshmcclure.com/',3.25),(49,'3227 Witting Landing\nFerrystad, WY 43540','Crooks, Corkery and Dickinson','11am - 11pm','http://hudson.com/',3.25),(50,'59694 Ulises Ranch Apt. 292\nRobelhaven, NY 81549','Jenkins-Greenholt','11am - 11pm','http://feil.net/',3.25),(51,'71811 Gertrude Via Suite 007\nSouth Taryn, NV 23967','Waters, Turner and Adams','9am -10pm','http://franeckikuhn.com/',3.25),(52,'09615 Green Shores Suite 103\nJaquanmouth, VA 66615','Hilpert, Von and Frami','11am - 11pm','http://gloverhansen.com/',3.25),(53,'7385 Douglas Rapid\nLake Eusebioberg, NV 04724','Larkin, Lakin and Huel','11am - 11pm','http://www.pfeffer.com/',3.25),(54,'121 Hartmann Falls Apt. 221\nEast Ashleyshire, CT 19450','Cremin Ltd','10am - 9pm','http://davis.com/',3.25),(55,'9775 Victoria Inlet\nWest Clifford, NV 16309-4617','Orn, Kshlerin and Ebert','10am - 9pm','http://www.wisokywilderman.net/',3.25),(56,'983 Macie Squares Apt. 211\nEast Lyda, PA 70725','Keeling-Jaskolski','11am - 11pm','http://doyle.com/',3.25),(57,'801 Strosin Village\nDouglasbury, WY 85892','Kuhn-Kuhn','10am - 9pm','http://www.blick.com/',3.25),(58,'162 Renner Walk\nNew Lexie, IN 72766','Runolfsdottir-Hagenes','9am -10pm','http://hickle.info/',3.25),(59,'207 Berge Turnpike\nNorth Bulah, NY 56382-2747','Bradtke, Johnston and Baumbach','11am - 11pm','http://jones.org/',3.25),(60,'93126 O\'Reilly Stream\nSouth Reneebury, NE 37534','Schulist-Dickinson','9am -10pm','http://www.huels.net/',3.25),(61,'7027 Harold Vista Apt. 309\nSouth Lamarchester, AK 74002','Rath, Lebsack and Hane','10am - 9pm','http://www.sawayn.com/',3.25),(62,'070 Valerie Radial\nLake Geraldine, ID 66048','Botsford Inc','9am -10pm','http://kesslergreenholt.com/',3.25),(63,'83563 Gabe Cliffs Suite 176\nMurraybury, MI 42637-0699','Klocko and Sons','9am -10pm','http://cruickshankhahn.org/',3.25),(64,'65258 Nelle Bypass Apt. 441\nNew Noemie, OR 56221-2401','Greenfelder-Strosin','11am - 11pm','http://www.quitzon.com/',3.25),(65,'392 Terry Common\nReneeburgh, GA 16078-5698','Volkman Group','10am - 9pm','http://hansen.com/',3.25),(66,'58362 Weimann View Apt. 783\nBorertown, IA 93172','Stanton-Marvin','10am - 9pm','http://johns.org/',3.25),(67,'7339 Ziemann Common\nWest Diamondport, NC 14355-1563','Huels, Schamberger and Volkman','9am -10pm','http://www.greenholtlittle.com/',3.25),(68,'172 Daisy Overpass\nFeestbury, MI 69119','Bahringer, Herman and Lebsack','10am - 9pm','http://www.reichert.info/',3.25),(69,'744 Trudie Row Apt. 555\nLake Eduardoport, AL 24252-6634','Von and Sons','9am -10pm','http://www.buckridge.com/',3.25),(70,'0420 Waelchi Ferry\nCedrickberg, KY 95033-5914','Daniel PLC','11am - 11pm','http://www.barton.com/',3.25),(71,'90000 Pinkie Summit\nSouth Ansleyport, NJ 05455','Daniel, Ledner and Keebler','9am -10pm','http://swift.com/',3.25),(72,'267 Kemmer Dam Suite 757\nLake Shanna, ND 06978-8017','Shields-Wehner','9am -10pm','http://maggiowisozk.com/',3.25),(73,'5242 Maymie Prairie\nJosephinechester, CT 08166','Davis-Gottlieb','10am - 9pm','http://kiehn.com/',3.25),(74,'503 Halvorson Roads\nEmilianomouth, WY 48846','Kuhic, DuBuque and Rutherford','10am - 9pm','http://mcdermott.com/',3.25),(75,'61619 White Lock\nKassulkeberg, SD 92407','Miller-Schuppe','9am -10pm','http://langworth.net/',3.25),(76,'2686 Rosina Drives\nLake Irving, WI 93674','Marquardt and Sons','9am -10pm','http://schoen.info/',3.25),(77,'665 Reba Field Suite 259\nAbbieville, HI 45209','Heller-Stoltenberg','10am - 9pm','http://keebler.net/',3.25),(78,'274 Aniyah View\nCorkerybury, NJ 42353-0485','Kub-Bartoletti','10am - 9pm','http://www.walkerschuster.biz/',3.25),(79,'136 Champlin Circles Suite 260\nElmiraburgh, NY 86723','Pollich-Connelly','10am - 9pm','http://quigleyjohns.com/',3.25),(80,'6656 Durgan Glens\nSidneyfort, NY 23527-3946','Predovic Group','11am - 11pm','http://www.mcclure.info/',3.25),(81,'916 Kenna Walks Apt. 224\nDomenichaven, SD 08585','Thiel-Paucek','11am - 11pm','http://www.klein.com/',3.25),(82,'87162 Keven Wall\nNew Amya, GA 23801-4982','Bednar and Sons','10am - 9pm','http://hamill.org/',3.25),(83,'32020 Langworth Way\nJaycefort, MT 55909','Sipes-Carroll','9am -10pm','http://larkin.net/',3.25),(84,'198 Mazie Bypass Apt. 852\nPort Newellland, ID 46813-6856','Kohler-Predovic','10am - 9pm','http://hermiston.com/',3.25),(85,'8170 Orn Pine\nJadonton, MN 06564-1919','Fisher, Yundt and Wiegand','10am - 9pm','http://friesen.com/',3.25),(86,'6809 Kulas Circles Suite 622\nPort Leonieland, KS 31358-9888','Corwin Inc','10am - 9pm','http://turner.com/',3.25),(87,'540 Maximillia Via Suite 247\nNew Christine, OH 16149-9776','Veum PLC','10am - 9pm','http://www.shields.biz/',3.25),(88,'8085 Alvina Isle Apt. 893\nJamisonland, MD 06507','Barrows Group','10am - 9pm','http://www.marquardtschumm.com/',3.25),(89,'7446 Jarrett Plaza\nNew Phoebeview, ME 25224','Kub, Hoeger and Swaniawski','10am - 9pm','http://www.haley.biz/',3.25),(90,'631 Wilkinson Shoal Apt. 785\nMadisynbury, NE 51948','Kerluke-Flatley','11am - 11pm','http://www.waters.net/',3.25),(91,'86467 Kshlerin Point\nHeathcotetown, AZ 27728-4616','Rowe, Pouros and Gutkowski','11am - 11pm','http://gerlach.com/',3.25),(92,'92578 Kylie Trafficway Suite 755\nLake Murphy, GA 78904','Grimes-Sporer','9am -10pm','http://www.osinski.com/',3.25),(93,'72392 Hahn Station Apt. 674\nWest Josianeside, MT 59330-3244','Price-Reinger','11am - 11pm','http://stoltenbergmohr.biz/',3.25),(94,'9329 Vesta Harbors Suite 849\nUllrichchester, DC 53814','Boehm, White and Kilback','9am -10pm','http://www.hillljohnson.com/',3.25),(95,'30248 Eichmann Street Suite 151\nLake Nelson, VT 78923-5543','Conroy-O\'Keefe','10am - 9pm','http://hermiston.org/',3.25),(96,'1070 Green Forks\nSelenaland, VT 70941','Wiegand LLC','9am -10pm','http://www.streich.com/',3.25),(97,'20073 Clyde Ways Suite 898\nWest Dejahchester, GA 59632','Donnelly and Sons','10am - 9pm','http://cummings.net/',3.25),(98,'215 Altenwerth Mall Apt. 621\nDietrichberg, MI 96944','McDermott, Senger and Ferry','10am - 9pm','http://www.collins.net/',3.25),(99,'1105 Liza Shores Apt. 158\nHermannland, GA 62111','Grimes-Lakin','9am -10pm','http://terry.net/',3.25),(100,'88626 Louvenia Fork\nLake Maxiefurt, TN 43522','Mertz Ltd','9am -10pm','http://ortiz.com/',3.25);
/*!40000 ALTER TABLE `restaurant` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `restaurant_rating_view`
--

DROP TABLE IF EXISTS `restaurant_rating_view`;
/*!50001 DROP VIEW IF EXISTS `restaurant_rating_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restaurant_rating_view` AS SELECT 
 1 AS `restaurant_id`,
 1 AS `restaurant_name`,
 1 AS `Driver_Count`,
...
--
/*!50003 DROP FUNCTION IF EXISTS `get_driver_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_driver_id`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AVG_Drv_Rating_calculator` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
Select driver.driver_id, p.person_name as driver_name, AVG(rating.driver_rating) as adriver_avg_rating 
from rating 
left join driver 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `avg_res_rate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Drv_Rating_calculator` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Res_Rating_calculator` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Res_Rating_calculator`(in `restaurant_id` int(11))
BEGIN
UPDATE restaurant
...
--
-- Final view structure for view `driver_rating_view`
--
...
/*!50001 VIEW `driver_rating_view` AS select `d`.`driver_id` AS `driver_id`,`p`.`person_name` AS `person_name`,count(`o`.`driver_id`) AS `Order Count`,avg(`r`.`driver_rating`) AS `Rating` from ((((`driver` `d` join `student` `s` on((`d`.`student_id` = `s`.`student_id`))) join `person` `p` on((`s`.`person_id` = `p`.`person_id`))) join `order` `o` on((`o`.`driver_id` = `d`.`driver_id`))) join `rating` `r` on((`r`.`driver_id` = `d`.`driver_id`))) group by `d`.`driver_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `order_rating_comparison`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `order_rating_comparison` AS with `order_ratings` as (select `rating`.`order_id` AS `order_id`,`rating`.`driver_id` AS `driver_id`,`rating`.`restaurant_id` AS `restaurant_id`,((`rating`.`driver_rating` + `rating`.`restaurant_rating`) / 2) AS `Average_Order_Rating` from `rating`) select `o`.`order_id` AS `order_id`,`o`.`driver_id` AS `driver_id`,`drv`.`person_name` AS `person_name`,`drv`.`Rating` AS `Driver Rating`,`o`.`restaurant_id` AS `restaurant_id`,`rrv`.`restaurant_name` AS `restaurant_name`,`rrv`.`Rating` AS `Restaurant_Rating`,`orra`.`Average_Order_Rating` AS `Average_Order_Rating`,avg(`orra`.`Average_Order_Rating`) OVER (PARTITION BY `o`.`driver_id` )  AS `Average Driver's Order's Rating`,avg(`orra`.`Average_Order_Rating`) OVER (PARTITION BY `o`.`restaurant_id` )  AS `Average Restaurant's Order's Rating` from (((`order` `o` left join `driver_rating_view` `drv` on((`o`.`driver_id` = `drv`.`driver_id`))) left join `restaurant_rating_view` `rrv` on((`o`.`restaurant_id` = `rrv`.`restaurant_id`))) left join `order_ratings` `orra` on((`o`.`order_id` = `orra`.`order_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `restaurant_rating_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restaurant_rating_view` AS select `r`.`restaurant_id` AS `restaurant_id`,`r`.`restaurant_name` AS `restaurant_name`,`g`.`Driver_Count` AS `Driver_Count`,count(`o`.`restaurant_id`) AS `Number of Orders`,avg(`ra`.`restaurant_rating`) AS `Rating` from (((`restaurant` `r` join (select `order`.`restaurant_id` AS `restaurant_id`,count(`order`.`driver_id`) AS `Driver_Count` from `order` group by `order`.`restaurant_id`) `g` on((`r`.`restaurant_id` = `g`.`restaurant_id`))) join `order` `o` on((`o`.`restaurant_id` = `g`.`restaurant_id`))) left join `rating` `ra` on((`r`.`restaurant_id` = `ra`.`restaurant_id`))) group by `g`.`restaurant_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-12-06 21:41:30
